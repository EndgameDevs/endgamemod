...
public class EndgameModForge {
    public EndgameModForge() {
        ...
        Endgame.init();
        ModLoadingContext.get().registerExtensionPoint(ConfigScreenHandler.ConfigScreenFactory.class, () -> new ConfigScreenHandler.ConfigScreenFactory((client, parent) -> MenuConfig.getConfigBuilderWithDemo().setParentScreen(parent).build()));
    }
}
