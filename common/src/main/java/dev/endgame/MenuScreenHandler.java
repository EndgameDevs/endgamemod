...
public class MenuScreenHandler extends AbstractContainerMenu {
    private final SimpleContainer inventory;

    public MenuScreenHandler(int syncId, Inventory inventory) {
        this(syncId, inventory, new SimpleContainer(3), new SimpleContainerData(2));
    }

    public MenuScreenHandler(int syncId, @NotNull Inventory playerInventory, SimpleContainer inventory, SimpleContainerData delegate) {
